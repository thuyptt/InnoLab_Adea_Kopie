...
source(file = "~/InnoLab-Adea/my_app/questionnaire_merged.R")
  ...
  navbarPage(title = div(img(src="adea_logo.svg", height='40', width='90', style="margin: -10px -10px; position : relative; display right-align;")), 
              ...
              tabPanel("Home",
                       ...
                       fluidRow(box(width=2),
                                ...
                                box(width=5, 
                                    title=h3("We Provide Many", span(strong("Features"), style="color: #823F54"),  "You Can Use", style = 'font-size:42px;color:black;'), # another color: #7c2946
                                    br(),
              ...
              # Share on social media buttons ----------------------------------
               ...
               header = tagList(tags$h5("Share on", style = "position: relative; top: -3px; right: -1460px;"), 
