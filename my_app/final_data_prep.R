...
# once the data_employee is created
# data_employee <- read.csv(file="~/InnoLab-Adea/datasets/final_datasets/data_employee.csv")
...
source(file = "~/InnoLab-Adea/my_app/google_data_merged_prep.R")
...
data <- rbind(data_final,  data_com_new, data_update_company)#data_emp_new,

# merge with the employee_data
# for the first time to create the file data_emp_merged
#data_emp_merged <- rbind(data_emp_new,data_update_employee) 
# later
#data_emp_merged <- rbind(data_employee,data_emp_new,data_update_employee) 

# Remove duplication
data <- unique(data)
# data_emp_merged <- unique(data_emp_merged)

## Save data for the visualization
#write.csv(data, file = "~/InnoLab-Adea/datasets/final_datasets/data.csv")
#write.csv(data_emp_merged, file = "~/InnoLab-Adea/datasets/final_datasets/data_employee.csv")
...
# Below show the table data_CM_merged for further info
