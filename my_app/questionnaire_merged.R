...
# 2. Google sheet authentification ---------------------------------------------
# options(
# # whenever there is one account token found, use the cached token
#   gargle_oauth_email = T,
# # specify auth tokens should be stored in a hidden directory ".secrets"
#   gargle_oauth_cache = "~/InnoLab-Adea/my_app/.secrets"
# )
...
#drive_auth(cache = "~/InnoLab-Adea/my_app/.secrets",
#          path =  "/InnoLab-Adea/worldmap/main_service.json")
#drive_auth()
#drive_auth(email = )
#gs4_deauth()
# if (interactive()){
...
#     cache = "~/InnoLab-Adea/my_app/.secrets",
#     use_oob = FALSE,
#     token = NULL
#   )
# }else{
...
#     email = ,
#     scopes = c("https://www.googleapis.com/auth/spreadsheets","https://www.googleapis.com/auth/drive"),
#     cache = "~/InnoLab-Adea/my_app"
#   )
# }
gs4_auth(cache ="~/InnoLab-Adea/my_app", email = T) #/.secrets
...
survey_questions_merged <- data.frame(
  ...
  #c(rep(NA, time = 100),JA)
  
  dependence_value = c(rep(NA, time = 404)),
  #c(rep(NA, time = 100),rep("researchlab", time = 7))
